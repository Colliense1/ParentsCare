...
public class Parentslogin extends AppCompatActivity implements
                ...
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            ...
                            // [END_EXCLUDE]
                            Toast.makeText(Parentslogin.this, " Please Check Your Internet Connection", Toast.LENGTH_SHORT).show();
