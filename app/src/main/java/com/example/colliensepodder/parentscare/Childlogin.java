...
import static com.example.colliensepodder.parentscare.ChildNav.tv1;
import static com.example.colliensepodder.parentscare.ParentsNav.tv;

public class Childlogin extends AppCompatActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mNameField = (EditText)findViewById(R.id.name_fields);
                ...
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            ...
                            // [END_EXCLUDE]
                            Toast.makeText(Childlogin.this, "Successfully", Toast.LENGTH_SHORT).show();
                        } else {
                            ...
                            // [END_EXCLUDE]
                            Toast.makeText(Childlogin.this, " Please Check Your Internet Connection", Toast.LENGTH_SHORT).show();
    ...
    private void updateUI(int uiState, FirebaseUser user, PhoneAuthCredential cred) {
        ...
        if (user == null) {
            ...
            */
            Intent intent = new Intent(this, ChildNav.class);
